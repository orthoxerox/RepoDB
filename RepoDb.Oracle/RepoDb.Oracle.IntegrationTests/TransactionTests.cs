    ...
    public class TransactionTests
    {
        ...
        public void TestDbTransactionForUpdateAsCommitted()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual("Test", queryResult.First().ColumnVarchar2);
            }
        }
        ...
        public void TestDbTransactionForUpdateAsRolledBack()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                // Assert
                Assert.AreEqual("ColumnVarchar21", queryResult.First().ColumnVarchar2);
            }
        }
        ...
        public void TestDbTransactionForUpdateAllAsCommitted()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                using (var transaction = connection.EnsureOpen().BeginTransaction())
                {
                    entities.ForEach(entity => entity.ColumnVarchar2 = "Test");
                ...
                // Assert
                entities.ForEach(entity => Assert.AreEqual("Test", queryResult.First(item => item.Id == entity.Id).ColumnVarchar2));
            }
        }
        ...
        public void TestDbTransactionForUpdateAllAsRolledBack()
        {
            ...
            using (var connection = new OracleConnection(Database.ConnectionString))
            {
                ...
                // Assert
                entities.ForEach(entity => Assert.AreEqual("ColumnVarchar21", queryResult.First(item => item.Id == entity.Id).ColumnVarchar2));
            }
        }
